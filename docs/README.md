...
- [`spec-admin.md`](product/spec-admin.md) — **l'espace Administration (2026-09-11)**, rang 4 : l'Admin comme poste d'observation du produit et pas seulement comme guichet de comptes. La barre à dix-sept entrées en quatre groupes, le régime de lecture de l'opérateur (I-24, masquage des petites cohortes), la règle **Élèves = gestion et dépannage, l'analyse pédagogique individuelle appartient au professeur**, la priorité donnée à l'agrégé pour comprendre et améliorer le moteur, l'état des six familles de vues avec les mesures de production qui les ont corrigées, et ce qui n'a aucune donnée aujourd'hui et ne doit donc pas être dessiné.
