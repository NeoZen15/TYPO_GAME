...
- [`spec-admin.md`](product/spec-admin.md) — **l'espace Administration (2026-09-11)**, rang 4 : l'Admin comme poste d'observation du produit et pas seulement comme guichet de comptes. Les six vues et leur ordre de construction, le régime de lecture de l'opérateur (I-24, masquage des petites cohortes), ce que chaque vue demande comme données, et ce qui n'en a aucune aujourd'hui et ne doit donc pas être dessiné.
